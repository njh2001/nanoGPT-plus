...
use_speculative = False # whether or not to use speculative decoding
...
if not use_speculative:
    ...
    from model_speculative import GPTConfig, GPT
...
elif init_from.startswith('gpt2-medium'):
